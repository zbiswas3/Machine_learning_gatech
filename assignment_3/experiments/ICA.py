...
class ICAExperiment(experiments.BaseExperiment):
    ...
    def __init__(self, details, verbose=False):
        ...
        self._nn_arch = [(32, 32), (32,), (16,), (16, 16), (32, 16, 32)]
        self._nn_reg = [10 ** -x for x in range(1, 5)]
        self._clusters = [2, 3, 4, 5, 6, 7, 8, 9, 10, 15, 20, 25]
        # this is for drybeans data
        self._dims = np.arange(2, details.ds.features.shape[1]-1)
        # this is for other datasets
