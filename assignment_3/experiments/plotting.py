...
def plot_sil_samples(title, df, n_clusters):
    ...
    silhouette_avg = df[df['type'] == 'Kmeans']['score'].mean()
    ...
    ax.axvline(x=silhouette_avg, color="red", linestyle="--", label="Avg Value: %.3f" % silhouette_avg)
