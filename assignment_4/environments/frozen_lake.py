...
MAPS = {
    ...
    "25x25": [
        'SFFFFFFFFFFFHHHFFFFFFFFFF',
        'FFHFHHFHHFFHFFFFFFFFFFFFF',
        'FHFHFFHFFHFHFHFFFFFFHFFFH',
        'HFHFFFFHHFFFHFFHFFFHFFFFF',
        'FFFFFHFHFHFFFHFFFFFFFFFHF',
        'HHFHFHFHFFHHFFHHFFFFFFFFH',
        'FFFFFFFFFFFFFFFFFFFFFFFFF',
        'FHFHFFFFFFFFFFHFFHFFFHFFF',
        'FFFFHFHHFFFFFFFFFFFFFFFFH',
        'HFHHFFFFFFHFHFFFHFHFHFFHF',
        'FHFFFFHFFFFFFFFFHHFFFHHFF',
        'FFFFFHFFFFFFFFFFFFFFHFFFH',
        'FFFHFFFFFFFFFFFFFFFFFFHFF',
        'FFFHFFFFFFFFFFFHFFFFFFFFF',
        'FFFHFFHFFHFFFFFFHFFFFFFFF',
        'FFFFFFFFHFFFFHFFFFFFFFFHF',
        'HFFFFFHHFHFFFFFFFFFFFHFFF',
        'FFFHFFHHFFFFHHFFHHHFFHFHH',
        'FFFFHFHFFFHFFHHHFFFFFHFFF',
        'FFFFFHFFFFFFFFFFFFFFFHFFF',
        'HFHFFFFFFHFHFFFHFHFFFHHFF',
        'HHFFFFHHFFFHFFFFHHFFFHFFF',
        'FHFFFFFFFFHFFFFFFFFFFFFFF',
        'FFHHFFHFFFFHFFFFFFFFFFFFF',
        'FFFFFFHHHFFFFFFHFFFFFFFHG'
    ]
}
